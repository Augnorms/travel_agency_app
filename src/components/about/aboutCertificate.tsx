...
export default function AboutCertificate() {
  return (
    <section className="py-16 px-6 bg-gray-50 space-y-24">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <Image
            src="/gallery-images/certificate.jpg" // Your first cert
            alt="Certificate"
            width={600}
            height={400}
      ...
      {/* Second certificate (flipped layout) */}
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <Image
            src="/donations/certificate_clockwise.jpeg" // replace with second cert
            alt="Certificate"
            width={600}
            height={400}
            className="rounded-lg object-contain"
          />
          <div className="absolute -bottom-4 -left-4 w-full h-full bg-yellow-100 rounded-2xl -z-10"></div>
        </div>

        {/* Right: Certificate Summary */}
        <div className="relative">
          <div
            className="bg-white rounded-2xl p-8 shadow-xl transform 
                       hover:scale-105 hover:-rotate-1 transition duration-500"
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Arkansas Traveler Recognition
            </h2>

            <p className="text-gray-600 text-lg leading-relaxed">
              This honor was awarded to{" "}
              <span className="font-semibold text-blue-600">Francis Mensah</span>{" "}
              as an{" "}
              <span className="font-semibold text-blue-600">Arkansas Traveler</span>, 
              recognizing his contributions to cultural exchange and goodwill 
              beyond the borders of the United States.
            </p>

            <p className="text-gray-600 text-lg leading-relaxed mt-4">
              The certificate was signed and issued by the{" "}
              <span className="font-semibold text-blue-600">Governor of Arkansas</span> 
               as an official acknowledgment of international friendship and cooperation.
            </p>
          ...
          {/* Stylish shadow */}
          <div className="absolute -bottom-6 -right-6 w-full h-full bg-green-100 rounded-2xl -z-10"></div>
        </div>
      </div>
    </section>
  );
